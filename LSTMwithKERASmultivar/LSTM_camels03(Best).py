...
# design network
model = Sequential()
model.add(LSTM(175, input_shape=(train_X.shape[1], train_X.shape[2]),return_sequences=True))
model.add(LSTM(175, input_shape=(train_X.shape[1], train_X.shape[2]),return_sequences=False))
