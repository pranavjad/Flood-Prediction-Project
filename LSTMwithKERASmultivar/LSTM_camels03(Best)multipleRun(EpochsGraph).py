...
for i in epochsList:
	...
	axes.plot(runsList, rmseList, color=color,marker='o',label=str(epochs),linestyle='None')
pyplot.figtext(0.5,0.03,txt,wrap=True,horizontalalignment='center',fontsize=12)
axes.legend(loc='upper left',bbox_to_anchor=(1,1),fontsize='small',title='Epochs')
pyplot.savefig("MultipleRunsRMSE(EpochsGraph)2.png")
