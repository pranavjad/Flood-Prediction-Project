...
hidden_nodes = 50
#int(2/3*(train_X.shape[0]*train_X.shape[2]))

print("Number of Hidden Nodes is: ",hidden_nodes)
# design network
model = Sequential()
model.add(LSTM(hidden_nodes, input_shape=(train_X.shape[1], train_X.shape[2]),return_sequences=True))
model.add(Dropout(0.2))
model.add(LSTM(hidden_nodes, input_shape=(train_X.shape[1], train_X.shape[2]),return_sequences=True))
model.add(Dropout(0.2))
model.add(LSTM(hidden_nodes, input_shape=(train_X.shape[1], train_X.shape[2]),return_sequences=False))
model.add(Dropout(0.2))
model.add(Dense(1))
