...
batch_size = 50
epochs = 50
input_neuronsList = [25,50,75,100,125,150,200,250,175,300]
...
txt = 'batch_size: {}, epochs: {}, output activation: {}, loss: {}, optimizer: {}, number of runs: {}'.format(
    batch_size,epochs, output_activation, loss, optimizer, num_runs)
...
for i in input_neuronsList:
	...
	axes.plot(runsList, rmseList, color=color,marker='o',label=str(input_neurons),linestyle='None')
	colorIndex+=1
pyplot.figtext(0.5,0.03,txt,wrap=True,horizontalalignment='center',fontsize=12)
axes.legend(loc='upper left',bbox_to_anchor=(1,1),fontsize='small',title='Input Neruons',title_fontsize='xx-small')
pyplot.savefig("MultipleRunsRMSE(NeuronsGraph)2.png")
